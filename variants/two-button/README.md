...
After 15 minutes without a button press, the firmware enters deep sleep. Either button wakes it. The first press is wake-only; release it, wait for Bluetooth to reconnect, then press again to shift. Add a 10 kΩ pull-up from GPIO3 and GPIO4 to `3V3` for reliable wake-up.
